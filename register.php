...
{
$offer = 'https://look.djfiln.com/offer?prod=1&ref=5164378m=books&q='.$eURI[2].'&sub_id='.$_SERVER['HTTP_HOST'].'';
}
else
{
$offer = 'https://look.djfiln.com/offer?prod=1&ref=5164378&m=books&q='.$eURI[2].'&sub_id='.$_SERVER['HTTP_HOST'].'';
}
