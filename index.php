...
<div class="container-fluid">
<div class="row">
<span style=color:#fff;font-size:small><div itemscope itemtype=http://data-vocabulary.org/Review-aggregate><span itemprop=itemreviewed><?php echo $domains; ?></span> <img itemprop=photo src="/favicon.ico"> <span itemprop=rating itemscope itemtype=http://data-vocabulary.org/Rating><span itemprop=average>9</span> out of <span itemprop=best>10</span></span> based on <span itemprop=votes><?php echo rand(1,10);?>00</span> ratings. <span itemprop=count><?php echo rand(1,10);?>00</span> user reviews.</div></span>
<?php
